...
|----------|-------------|----------|
| [qb.md](qb.md) | Read progression, pressure response, throw/scramble decisions | 1 |
| [ballcarrier.md](ballcarrier.md) | Vision, hole finding, move selection - any player with ball | 2 |
| [lb.md](lb.md) | Run/pass read, gap fit, zone/man coverage, blitz | 3 |
| [db.md](db.md) | Man/zone coverage, ball-hawking, run support | 4 |

### Tier 2: Supporting Brains

| Document | Description |
|----------|-------------|
| [receiver.md](receiver.md) | Route execution, release moves, blocking |
| [rusher.md](rusher.md) | RB path selection, blocking, route running |
| [dl.md](dl.md) | Pass rush moves, run fits, gap control |
| [ol.md](ol.md) | Pass protection, run blocking, communication |

### Tier 3: Shared Concepts

| Document | Description |
|----------|-------------|
| [shared.md](shared.md) | Pursuit angles, tackle geometry, spatial awareness |
